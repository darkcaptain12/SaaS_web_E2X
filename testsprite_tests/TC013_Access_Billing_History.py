...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Faturalama' (Billing) link in the sidebar to go to billing history page.
        frame = context.pages[-1]
        # Click on 'Faturalama' (Billing) link in the sidebar
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=17 Kasım 2025').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=QR Menü & Self-Servis').first).to_be_visible(timeout=30000)
