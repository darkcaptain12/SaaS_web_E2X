...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the login page by clicking the 'Giriş' link.
        frame = context.pages[-1]
        # Click the 'Giriş' (Login) link to navigate to the login page.
        elem = frame.locator('xpath=html/body/nav/div/div/div[2]/a[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Input the registered email 'e2xldigital@gmail.com' and an incorrect password 'wrongpassword'.
        frame = context.pages[-1]
        # Input the registered email into the email field.
        ...
        frame = context.pages[-1]
        # Click the 'Giriş Yap' (Login) button to submit the login form with incorrect password.
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Email veya şifre hatalı').first).to_be_visible(timeout=30000)
