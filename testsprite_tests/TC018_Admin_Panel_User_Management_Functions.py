...
async def run_test():
    ...
    try:
        ...
        # -> Click on the 'Giriş' (Login) link to proceed to login page.
        ...
        # -> Click on 'Yönetim' (Management) menu or 'Yönetim Paneline Git' button to go to user management section.
        frame = context.pages[-1]
        # Click on 'Yönetim' (Management) menu to navigate to user management section
        elem = frame.locator('xpath=html/body/nav/div/div/div[2]/a[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        try:
            ...
            raise AssertionError("Test case failed: Admin user management test did not complete successfully. The test plan execution failed to verify that admin can view, filter, and manage users, including role changes and status updates.")
